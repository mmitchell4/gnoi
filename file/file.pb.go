...
type TransferFromRemoteRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *TransferFromRemoteRequest) Reset() {
	*x = TransferFromRemoteRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *TransferFromRemoteRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TransferFromRemoteRequest) ProtoMessage() {}

func (x *TransferFromRemoteRequest) ProtoReflect() protoreflect.Message {
	mi := &file_file_file_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TransferFromRemoteRequest.ProtoReflect.Descriptor instead.
func (*TransferFromRemoteRequest) Descriptor() ([]byte, []int) {
	return file_file_file_proto_rawDescGZIP(), []int{6}
}

func (x *TransferFromRemoteRequest) GetLocalPath() string {
	if x != nil {
		return x.LocalPath
	}
	return ""
...
func (x *TransferFromRemoteRequest) GetRemoteDownload() *common.RemoteDownload {
	if x != nil {
		return x.RemoteDownload
	}
	return nil
...
type TransferFromRemoteResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *TransferFromRemoteResponse) Reset() {
	*x = TransferFromRemoteResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *TransferFromRemoteResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TransferFromRemoteResponse) ProtoMessage() {}

func (x *TransferFromRemoteResponse) ProtoReflect() protoreflect.Message {
	mi := &file_file_file_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TransferFromRemoteResponse.ProtoReflect.Descriptor instead.
func (*TransferFromRemoteResponse) Descriptor() ([]byte, []int) {
	return file_file_file_proto_rawDescGZIP(), []int{7}
}

func (x *TransferFromRemoteResponse) GetHash() *types.HashType {
	if x != nil {
		return x.Hash
	}
	return nil
...
var file_file_file_proto_rawDesc = []byte{
	...
	0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x68, 0x61, 0x73, 0x68, 0x22, 0x80, 0x01, 0x0a, 0x19, 0x54,
	0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x46, 0x72, 0x6f, 0x6d, 0x52, 0x65, 0x6d, 0x6f, 0x74,
	0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x6c, 0x6f, 0x63, 0x61,
	0x6c, 0x5f, 0x70, 0x61, 0x74, 0x68, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x6c, 0x6f,
	0x63, 0x61, 0x6c, 0x50, 0x61, 0x74, 0x68, 0x12, 0x44, 0x0a, 0x0f, 0x72, 0x65, 0x6d, 0x6f, 0x74,
	0x65, 0x5f, 0x64, 0x6f, 0x77, 0x6e, 0x6c, 0x6f, 0x61, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b,
	...
	0x65, 0x6d, 0x6f, 0x74, 0x65, 0x44, 0x6f, 0x77, 0x6e, 0x6c, 0x6f, 0x61, 0x64, 0x22, 0x46, 0x0a,
	0x1a, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x46, 0x72, 0x6f, 0x6d, 0x52, 0x65, 0x6d,
	...
	0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xba, 0x03, 0x0a, 0x04, 0x46, 0x69,
	...
	0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x63, 0x0a, 0x12, 0x54,
	0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x46, 0x72, 0x6f, 0x6d, 0x52, 0x65, 0x6d, 0x6f, 0x74,
	0x65, 0x12, 0x24, 0x2e, 0x67, 0x6e, 0x6f, 0x69, 0x2e, 0x66, 0x69, 0x6c, 0x65, 0x2e, 0x54, 0x72,
	0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x46, 0x72, 0x6f, 0x6d, 0x52, 0x65, 0x6d, 0x6f, 0x74, 0x65,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x25, 0x2e, 0x67, 0x6e, 0x6f, 0x69, 0x2e, 0x66,
	0x69, 0x6c, 0x65, 0x2e, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x46, 0x72, 0x6f, 0x6d,
...
var file_file_file_proto_goTypes = []interface{}{
	...
	(*TransferFromRemoteRequest)(nil),  // 6: gnoi.file.TransferFromRemoteRequest
	(*TransferFromRemoteResponse)(nil), // 7: gnoi.file.TransferFromRemoteResponse
	(*StatRequest)(nil),                // 8: gnoi.file.StatRequest
	(*StatResponse)(nil),               // 9: gnoi.file.StatResponse
	(*StatInfo)(nil),                   // 10: gnoi.file.StatInfo
	(*RemoveRequest)(nil),              // 11: gnoi.file.RemoveRequest
	(*RemoveResponse)(nil),             // 12: gnoi.file.RemoveResponse
	(*PutRequest_Details)(nil),         // 13: gnoi.file.PutRequest.Details
	(*types.HashType)(nil),             // 14: gnoi.types.HashType
	(*common.RemoteDownload)(nil),      // 15: gnoi.common.RemoteDownload
}
var file_file_file_proto_depIdxs = []int32{
	13, // 0: gnoi.file.PutRequest.open:type_name -> gnoi.file.PutRequest.Details
	14, // 1: gnoi.file.PutRequest.hash:type_name -> gnoi.types.HashType
	14, // 2: gnoi.file.GetResponse.hash:type_name -> gnoi.types.HashType
	15, // 3: gnoi.file.TransferToRemoteRequest.remote_download:type_name -> gnoi.common.RemoteDownload
	14, // 4: gnoi.file.TransferToRemoteResponse.hash:type_name -> gnoi.types.HashType
	15, // 5: gnoi.file.TransferFromRemoteRequest.remote_download:type_name -> gnoi.common.RemoteDownload
	14, // 6: gnoi.file.TransferFromRemoteResponse.hash:type_name -> gnoi.types.HashType
	10, // 7: gnoi.file.StatResponse.stats:type_name -> gnoi.file.StatInfo
	2,  // 8: gnoi.file.File.Get:input_type -> gnoi.file.GetRequest
	4,  // 9: gnoi.file.File.TransferToRemote:input_type -> gnoi.file.TransferToRemoteRequest
	6,  // 10: gnoi.file.File.TransferFromRemote:input_type -> gnoi.file.TransferFromRemoteRequest
	0,  // 11: gnoi.file.File.Put:input_type -> gnoi.file.PutRequest
	8,  // 12: gnoi.file.File.Stat:input_type -> gnoi.file.StatRequest
	11, // 13: gnoi.file.File.Remove:input_type -> gnoi.file.RemoveRequest
	3,  // 14: gnoi.file.File.Get:output_type -> gnoi.file.GetResponse
	5,  // 15: gnoi.file.File.TransferToRemote:output_type -> gnoi.file.TransferToRemoteResponse
	7,  // 16: gnoi.file.File.TransferFromRemote:output_type -> gnoi.file.TransferFromRemoteResponse
	1,  // 17: gnoi.file.File.Put:output_type -> gnoi.file.PutResponse
	9,  // 18: gnoi.file.File.Stat:output_type -> gnoi.file.StatResponse
	12, // 19: gnoi.file.File.Remove:output_type -> gnoi.file.RemoveResponse
...
func file_file_file_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_file_file_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TransferFromRemoteRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_file_file_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TransferFromRemoteResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
